...
helm.sh/chart: {{ include "zortenet.chart" . }}
{{ include "zortenet.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "zortenet.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "zortenet.fullname" .) .Values.serviceAccount.name }}
{{- else }}
