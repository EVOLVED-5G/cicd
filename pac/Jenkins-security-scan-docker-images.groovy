            ...
            steps {
                dir("${WORKSPACE}/") {
                    ...
                    do
                        ...
                        python3 utils/report_generator.py --template templates/step-security-scan-docker-images.md.j2 --json ${REPORT_FILENAME}-$x.json --output ${REPORT_FILENAME}-$x.md --repo ${GIT_NETAPP_URL} --branch ${GIT_NETAPP_BRANCH} --commit commit --version $versionT --url $urlT --name $NETAPP_NAME
